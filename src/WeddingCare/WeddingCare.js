...
const WeddingCare = () => {
    ...
    <div className=" mt-5">
        <p className='carousel-h1 text-center underline mb-5 mt-5'>Wedding Day Pet Care</p>
        <p className='text-center'>We will provide pet care during your wedding day! This can be at the reception or in the comfort of your home or hotel! Different Packages:</p>

        <div className='col-12'>
                <div className='row justify-content-around align-items-center'>
                    <div className='shadow info-cta-wc col-lg-3 col-12 mt-5'>
                        <div>
                    ...
                    <div className='shadow info-cta-wc col-lg-3 col-12 text-center mt-5'>
                ...
                <p className='mt-5 text-center'>**Please let me know the behavior you are wanting. Depending on what you are looking for, multiple training prep sessions might be necessary </p>
                <p className='text-center'>*Additional fees may apply if outside the 30 miles</p>
            </div>
    ...
    <div className=" mt-5 text-center">
        ...
        <p className='mt-5'>$50 per 1 hour session & Must have a Wedding Day Pet Care Package already. </p>
    </div>
