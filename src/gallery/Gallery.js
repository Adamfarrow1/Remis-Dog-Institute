                  ...
                  <p className="text-center grad-width mx-auto mt-5">Welcome to our Gallery section, where you'll find heartwarming snapshots of canine companions mastering obedience skills and overcoming behavioral challenges. Witness the bond between humans and their furry friends, as they embark on a transformative journey of love and learning. From playful puppies to seasoned pros, our gallery celebrates the magic of positive dog training in action. Get inspired to create your own harmonious relationship with your beloved companion.</p>
                    <Carousel fade interval={10000} variant="dark" className='gallery-width pb-5 mt-5' onSlide={(e) => {handleSlide(e)}}>
                        <Carousel.Item className="d-flex justify-content-center" >
                            <ReactPlayer ref={playerRef} controls={false} playing={true} loop={true} muted={inView ? m1 : true} url={dog7} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                            <ReactPlayer ref={playerRef1} controls={false} playing={true} loop={true} muted={inView ? m2 : true} url={dog2} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                             <ReactPlayer ref={playerRef2} controls={false} playing={true} loop={true} muted={inView ? m3 : true} url={dog3} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                            <ReactPlayer ref={playerRef3} controls={false} playing={true} loop={true} muted={inView ? m4 : true} url={dog4} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                            <ReactPlayer ref={playerRef4} controls={false} playing={true} loop={true} muted={inView ? m5 : true} url={dog5} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                             <ReactPlayer ref={playerRef5}  controls={false} playing={true} loop={true} muted={inView ? m6 : true} url={dog6} />
                        </Carousel.Item>
                        <Carousel.Item className="d-flex justify-content-center">
                             <ReactPlayer ref={playerRef6} controls={false} playing={true} loop={true} muted={inView ? m7 : true} url={dog1} />
                        </Carousel.Item>
                    </Carousel>
                    </div>
              </div>
